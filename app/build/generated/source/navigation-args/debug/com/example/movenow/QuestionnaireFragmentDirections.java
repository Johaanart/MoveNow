...
public class QuestionnaireFragmentDirections {
  ...
  @CheckResult
  @NonNull
  public static ActionQuestionnaireFragmentToStartFragment actionQuestionnaireFragmentToStartFragment(
      ) {
    return new ActionQuestionnaireFragmentToStartFragment();
  }

  public static class ActionQuestionnaireFragmentToStartFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionQuestionnaireFragmentToStartFragment() {
    }

    @NonNull
    @SuppressWarnings("unchecked")
    public ActionQuestionnaireFragmentToStartFragment setUSERHASEXERCISED(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionQuestionnaireFragmentToStartFragment setUSERHASPAIN(boolean USERHASPAIN) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionQuestionnaireFragmentToStartFragment setUSERINTENSITY(
        @NonNull String USERINTENSITY) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionQuestionnaireFragmentToStartFragment setUSERGOAL(@NonNull String USERGOAL) {
      if (USERGOAL == null) {
    ...
    public int getActionId() {
      return R.id.action_questionnaireFragment_to_startFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionQuestionnaireFragmentToStartFragment that = (ActionQuestionnaireFragmentToStartFragment) object;
    ...
    public String toString() {
      return "ActionQuestionnaireFragmentToStartFragment(actionId=" + getActionId() + "){"
